...
from SiO.member.models import Association, AssociationSummary, Member, MemberSummary
...
#
# @admin.register(MemberSummary)
# class ChartMemberAdmin(admin.ModelAdmin):
#     change_list_template = 'admin/chart_member.html'
#     # change_list_template = 'admin/SiO/extras/sometemplate_change_form.html'
#     # date_hierarchy = 'reg_date'
#
#     # def get_total(self):
...
#
#     def changelist_view(self, request, extra_context=None):
#         response = super(ChartMemberAdmin, self).changelist_view(
#             request,
#             extra_context=extra_context,
#         )
#         try:
...
#         }
#         response.context_data['summary'] = list(
#             qs.values('gender').annotate(**metrics)
#             # qs2.values('member__asoc_name'),
#         )
#         response.context_data['summary_total'] = dict(
#             qs.aggregate(**metrics)
